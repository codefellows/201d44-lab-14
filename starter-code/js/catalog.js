...
function addSelectedItemToCart() {
  ...
  var grabElement = document.getElementById('items');
  var itemPicked = grabElement.options[grabElement.selectedIndex].value;
  // TODO: get the quantity
  var numberOfItemsPicked = document.getElementById('catalog').elements['quantity'].value;
